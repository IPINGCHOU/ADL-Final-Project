...
class DQN(nn.Module):
    ...
    def __init__(self, channels, num_actions):
        ...
        self.fc1_adv = nn.Linear(in_features=1600, out_features=512)#
        self.fc1_val = nn.Linear(in_features=1600, out_features=512)#
    ...
    def forward(self, x):
        ...
        adv = self.lrelu(self.fc1_adv(x.view(x.size(0), -1)))#
        val = self.lrelu(self.fc1_val(x.view(x.size(0), -1)))#
